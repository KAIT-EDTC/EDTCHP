const content = [
    { date: "2024-06-22", title: "第五回遊行塾に行ってきました", img: "blog/blog-img/24-0622-yugyou1.jpg", caption: "前期最終回となる遊行塾でしたが、楽しく学べる授業を提供できたと思います。当サイト初のブログになりますので至らぬ点もあるかと思いますが読んでいただけたら幸いです。", author: "山口", link: "blog/blog-data/yugyou5-blog.html" },
    { date: "2024-06-29", title: "神奈川工科大学見学体験ツアーを行いました", img: "blog/blog-img/24-0629-asahi1.png", caption: "本年度二回目となるあさひ学苑さんとのイベントを行いました。今回も弊学に来ていただき学内を探索したり工房にて缶バッチ制作をしていただきました", author: "山口", link: "blog/blog-data/asahi.blog.html" },
    ...
    { date: "2024-09-28", title: "第六回遊行塾に行ってきました", img: "blog/blog-img/24-0928-yugyou6.jpg", caption: "嶺学園藤沢中学校に第六回遊行塾を実施しました。後期始めにふさわしい快調なスタートを切ることが出来ました", author: "根本", link: "blog/blog-data/yugyou6-blog.html" },
