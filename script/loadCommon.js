...
function renderHeader(basePath) {
    ...
    <header class="header">
        ...
        <!--==========モバイルのみ表示==========-->
        <nav class="sp-only header__nav">
            <div class="gnav-toggle">
                <input id="gnav-input" type="checkbox" class="gnav-hidden" aria-label="メニュー切り替え">
                <label id="gnav-open" for="gnav-input"><span></span></label>
                <label id="gnav-close" for="gnav-input"></label>
                <div id="gnav-content">
                    <ul class="gnav-menu">
        ...
        <!--==========PCのみ表示==========-->
        <nav class="pc-only header__nav">
            <ul class="header__nav-list">
                <li class="gnav-sec header__nav-item"><a href="${basePath}base.html"><span>Home</span><br>ホーム</a></li>
